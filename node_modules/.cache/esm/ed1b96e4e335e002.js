let getTemplate,listFiles,readFileAsync,join,writeFileSync,mkdirSync;_e33‍.x([["createRouterFile",()=>createRouterFile],["modifyRouteIndex",()=>modifyRouteIndex]]);_e33‍.w("../utils",[["getTemplate",["getTemplate"],function(v){getTemplate=v}],["listFiles",["listFiles"],function(v){listFiles=v}],["readFileAsync",["readFileAsync"],function(v){readFileAsync=v}]]);_e33‍.w("path",[["join",["join"],function(v){join=v}]]);_e33‍.w("fs",[["writeFileSync",["writeFileSync"],function(v){writeFileSync=v}],["mkdirSync",["mkdirSync"],function(v){mkdirSync=v}]]);
...
`;
       ...
       const createRouterFile = async (endpoint) => {
  ...
  return true;
       ...
       const modifyRouteIndex = async (endpoint) => {
