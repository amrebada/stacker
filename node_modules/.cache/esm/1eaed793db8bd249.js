let getTemplate,listFiles,join,writeFileSync;_db8‍.x([["createControllerFile",()=>createControllerFile]]);_db8‍.w("../utils",[["getTemplate",["getTemplate"],function(v){getTemplate=v}],["listFiles",["listFiles"],function(v){listFiles=v}]]);_db8‍.w("path",[["join",["join"],function(v){join=v}]]);_db8‍.w("fs",[["writeFileSync",["writeFileSync"],function(v){writeFileSync=v}]]);
...
`;
       ...
       const createControllerFile = async (endpoint) => {
